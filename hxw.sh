...
cmake .. -DOQS_USE_CUPQC=ON -DOQS_USE_AVX2_INSTRUCTIONS=OFF -DOQS_DIST_X86_64_BUILD=OFF -DCMAKE_PREFIX_PATH=/home/hxw/TLS/cupqc/cupqc-pkg-0.2.0 -DOQS_ENABLE_KEM_fptru_761_cuda=ON -DOQS_ENABLE_KEM_fptru_761_ref_batch=ON -DOQS_ENABLE_KEM_fptru_761_ref=OFF -DOQS_ENABLE_KEM_ntruprime_sntrup761_avx2=OFF
make -j4